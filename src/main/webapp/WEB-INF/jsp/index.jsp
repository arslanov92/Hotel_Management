...
<html>
    <head>
        ...
        <ul id="index">  
            ...
            <li><a href="<c:url value='/private/admin'/>"> Админ (JAAS JDBC Realm)</a></li>
            <li><a href="<c:url value='webService'/> ">Web service(SPRING RESTful) Посмотреть свободные комнаты</a></li>
        </ul>
    </body>
</html>
